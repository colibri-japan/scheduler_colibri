	...
	def self.group_by_kana
		{
			...
			'か' => where( "kana LIKE 'か%' OR kana LIKE 'き%'  OR kana LIKE 'く%' OR kana LIKE 'け%' OR kana LIKE 'こ%' OR kana LIKE 'カ%' OR kana LIKE 'キ%'  OR kana LIKE 'ク%' OR kana LIKE 'ケ%' OR kana LIKE 'コ%' OR kana LIKE 'が%' OR kana LIKE 'ぎ%'  OR kana LIKE 'ぐ%' OR kana LIKE 'げ%' OR kana LIKE 'ご%' OR kana LIKE 'ガ%' OR kana LIKE 'ギ%'  OR kana LIKE 'グ%' OR kana LIKE 'ゲ%' OR kana LIKE 'ゴ%'" ),
			'さ' => where( "kana LIKE 'さ%' OR kana LIKE 'し%'  OR kana LIKE 'す%' OR kana LIKE 'せ%' OR kana LIKE 'そ%' OR kana LIKE 'サ%' OR kana LIKE 'シ%'  OR kana LIKE 'ス%' OR kana LIKE 'セ%' OR kana LIKE 'ソ%' OR kana LIKE 'ざ%' OR kana LIKE 'じ%'  OR kana LIKE 'ず%' OR kana LIKE 'ぜ%' OR kana LIKE 'ぞ%' OR kana LIKE 'ザ%' OR kana LIKE 'ジ%'  OR kana LIKE 'ズ%' OR kana LIKE 'ゼ%' OR kana LIKE 'ゾ%'" ),
			...
			'わ' => where( "kana LIKE 'わ%' OR kana LIKE 'を%'  OR kana LIKE 'ん%' OR kana LIKE 'ワ%' OR kana LIKE 'ヲ%' OR kana LIKE 'ン%'" ),
			'カナなし' => where(kana: [nil, ''])
		}
	end
