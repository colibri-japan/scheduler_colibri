class PatientsController < ApplicationController
  ...
  def patient_params
    params.require(:patient).permit(:name, :kana, :phone_mail, :phone_number, :address, :gender, :description, :team_id, :handicap_level, :kaigo_level, :nurse_id, :doctor_name, :care_manager_name, :care_manager_id, :second_care_manager_id, :date_of_contract, :insurance_id, :birthday, :kaigo_certification_date, :kaigo_certification_validity_start, :kaigo_certification_validity_end, :ratio_paid_by_patient, :public_assistance_id_1, :public_assistance_receiver_number_1, :public_assistance_id_2, :public_assistance_receiver_number_2, :end_of_contract, :issuing_administration_number, :issuing_administration_name, :emergency_contact_1_name, :emergency_contact_1_address, :emergency_contact_1_phone, :emergency_contact_1_relationship, :emergency_contact_1_living_with_patient, :emergency_contact_2_name, :emergency_contact_2_address, :emergency_contact_2_phone, :emergency_contact_2_relationship, :care_instructions, :emergency_contact_2_living_with_patient, caveat_list:[], care_plans_attributes: [:id, :care_manager_id, :kaigo_certification_date, :kaigo_certification_validity_start, :kaigo_certification_validity_end, :kaigo_level, :short_term_goals,:long_term_goals, :family_wishes, :patient_wishes, :handicap_level, insurance_policy: []])
  end
end
