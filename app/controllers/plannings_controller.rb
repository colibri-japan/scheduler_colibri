class PlanningsController < ApplicationController
	...
	def monthly_general_report
		...
		@provided_services = @planning.provided_services.where(archived_at: nil, cancelled: false, countable: false, service_date: start_date..end_date).from_appointments.includes(:nurse, :appointment).where(appointments: {edit_requested: false})
