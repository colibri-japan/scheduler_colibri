class UpdateServicesWorker
  ...
  def perform(service_id, service_ids_array)
    ...
    services_to_update.update_all(
      ...
      official_title: updated_service.official_title, 
      unit_credits: updated_service.unit_credits, 
      service_code: updated_service.service_code, 
      credit_calculation_method: updated_service.credit_calculation_method, 
      insurance_category_1: updated_service.insurance_category_1,
      insurance_category_2: updated_service.insurance_category_2,
      invoiced_amount: updated_service.invoiced_amount,
