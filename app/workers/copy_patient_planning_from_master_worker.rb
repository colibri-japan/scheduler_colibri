class CopyPatientPlanningFromMasterWorker
  ...
  def perform(patient_id, planning_id)
    ...
    recurring_appointments = patient.recurring_appointments.valid.edit_not_requested.from_master.where(planning_id: planning.id)
