...
json.array! appointments do |appointment|
	...
	json.extract! recurring_appointment, :description, :color, :master, :displayable, :frequency, :edit_requested, :patient_id, :nurse_id, :cancelled
	...
	json.patient do  
		...
		json.id recurring_appointment.patient.id 
	end
	json.nurse do   
